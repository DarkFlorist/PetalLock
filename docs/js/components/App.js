...
const WalletComponent = ({ maybeAccountAddress, loadingAccount, isWindowEthereum }) => {
    if (!isWindowEthereum.value)
        return _jsx("p", { class: 'paragraph', children: " An Ethereum enabled wallet is required to make immutable domains." });
