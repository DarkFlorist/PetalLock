...
export const Immutable = ({ checkBoxesArray }) => {
    ...
    return _jsxs("div", { children: [_jsx("div", { style: 'padding-top: 30px; padding-bottom: 30px; align-items: center; display: grid; width: 100%', children: checkBoxes.immutable ? _jsx(_Fragment, { children: _jsx("p", { class: 'status-green', children: `IMMUTABLE for about ${dateDiff} (until ${dateString})` }) }) : _jsx("p", { class: 'status-red', children: " NOT IMMUTABLE " }) }), checkBoxes.immutable ? _jsx(_Fragment, {}) : _jsxs("p", { style: 'margin: 0px; margin-bottom: 10px; padding-left: 10px;', class: 'requirement', children: [" ", checkBoxes.domainInfo.subDomain, " should satisfy the following conditions to be immutable: "] })] });
};
