...
export declare const ENS_TOKEN_WRAPPER = "0xD4416b13d2b3a9aBae7AcD5D6C2BbDBE25686401";
...
export declare const FINAL_CHILD_FUSES: readonly ["Cannot Unwrap Name", "Cannot Burn Fuses", "Cannot Set Resolver", "Cannot Set Time To Live", "Cannot Create Subdomain", "Cannot Approve", "Parent Domain Cannot Control", "Can Extend Expiry"];
export declare const SINGLE_DOMAIN_FUSES: readonly ["Cannot Unwrap Name", "Is .eth domain"];
export declare const TOP_PARENT_FUSES: readonly ["Is .eth domain", "Cannot Unwrap Name", "Cannot Approve"];
